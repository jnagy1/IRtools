function [A, b, x, ProbInfo] = PRblurspeckle(varargin) 
% PRblurspeckle Image deblurring problem with a speckle point spread function
%
% [A, b, x, ProbInfo] = PRblurspeckle
% [A, b, x, ProbInfo] = PRblurspeckle(n)
% [A, b, x, ProbInfo] = PRblurspeckle(n, options)
% [A, b, x, ProbInfo] = PRblurspeckle(options)
%
% Generates data for use in image deblurring problems with a speckle point
% spread function that models atmospheric blur.
%
% Input:
...
% PRblurrotation, PRblurshake, PRdiffusion, PRinvinterp2, PRnmr, PRseismic,
% PRspherical, PRtomo, PRnoise, PRshowb, PRshowx, fspecial
...
options = PRset(options, 'PSF', 'speckle');
