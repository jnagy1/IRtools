function [A, b, x, ProbInfo] = PRblurmotion(varargin) 
% PRblurmotion Image deblurring problem with linear motion blur
%
% [A, b, x, ProbInfo] = PRblurmotion
% [A, b, x, ProbInfo] = PRblurmotion(n)
...
% simulates linear motion at a 45 degree angle.
%
% Input:
...
%
% See also: PRblur, PRblurdefocus, PRblurgauss, PRblurrotation,
...
options = PRset(options, 'PSF', 'motion');
